                                    ...
                                    while($row = $result->fetch_assoc()){
                                        ...
                                        if($row['status'] == 'Pending'){
                                            ...
                                            echo "<td><label class='label bg-red'>".$row['status']."</label></td>";
                                                ...
                                                echo "<td><button type='button' class='btn btn-xs bg-blue waves-effect viewOrder' data-id='".$row['order_id']."'>View</button> <button  type='button' class='btn btn-xs bg-red waves-effect removeOrder'  data-id='".$row['order_id']."'>Remove</button></td>
                                            </tr>";
                                    }
                                ?>
                            </tbody>
